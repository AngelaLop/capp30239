...
![alt text](../graphs/bar_education_attainment_by_country.png)
![alt text](../graphs/shape_education_regional_attainment_variation.png)

![alt text](../graphs/bar_education_enrollment_by_country.png)
![alt text](../graphs/shape_education_regional_enrollment_variation.png)
...
![alt text](../graphs/bar_health_child_survival_rate_by_country.png)
![alt text](../graphs/shape_health_regional_child_survival_rate_variation.png)

![alt text](../graphs/bar_health_life_expectancy_by_country.png)
![alt text](../graphs/shape_health_regional_life_expectancy_variation.png)

More importantly, these inequalities have increased in recent years.

![alt text](../graphs/trend_education_attainment_gap_selected_countries.png)
